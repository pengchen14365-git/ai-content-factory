...
def main():
    ...
    print("=" * 50)
    print("=== YouTube Video Chapter Processing Script ===")
    print("=" * 50)
    ...
    for i, chapter in enumerate(chapters_data['chapters'], 1):
        ...
        print(f"Processing chapter {i}/{total_chapters}: {chapter_title}")
...
"""
        ...
        print(f"  [OK] Chapter {chapter_index} processing completed!")
        print()
    ...
    print("-" * 50)
    print("All chapters processing completed!")
    print(f"Output directory: {output_dir}")
